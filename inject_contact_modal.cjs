...
// 2. Build the Contact Modal Component string
...
// 3. Change the CTA button link
app = app.replace(
    /onClick=\{\(\) => window\.open\('https:\/\/viralacquisition\.it\/contact', '_blank'\)\}/g,
    `onClick={() => setShowContactModal(true)}`
);

fs.writeFileSync('src/App.jsx', app, 'utf8');
console.log('Injected Internal Contact Modal!');
