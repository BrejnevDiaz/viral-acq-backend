          ...
          <section className="p-mobile-sm" style={{ maxWidth: 1200, margin: '100px auto', padding: '0 24px', position: 'relative' }}>
              <div className="flex-col-mobile" style={{ display: 'flex', gap: 60, alignItems: 'center', background: 'linear-gradient(135deg, rgba(16,185,129,0.05), rgba(0,0,0,0))', borderRadius: 32, padding: 60, border: '1px solid rgba(16,185,129,0.1)', position: 'relative', overflow: 'hidden' }}>
                  ...
                  <div className="w-full-mobile text-center-mobile" style={{ flex: 1, zIndex: 10 }}>
                      ...
                      <h2 className="text-mobile-h2" style={{ fontSize: 48, fontWeight: 800, color: '#fff', marginBottom: 24, letterSpacing: '-1px', lineHeight: 1.1 }}>{uiLang === 'fr' ? 'Monétisez votre audience. ' : uiLang === 'it' ? 'Monetizza la tua audience. ' : 'Monetize your audience. '}<br/><span style={{ color: '#10B981' }}>{uiLang === 'fr' ? 'Sans intermédiaire, sans commission.' : uiLang === 'it' ? 'Senza intermediari, zero commissioni.' : 'No middleman, zero commission.'}</span></h2>
                      <p className="text-mobile-p" style={{ color: '#A1A1AA', fontSize: 18, marginBottom: 40, lineHeight: 1.6 }}>{uiLang === 'fr' ? "Rejoignez le réseau privé d'Acquisition Pro : notre IA vous connecte directement aux marques les plus rentables de votre niche — sans DM à rallonge, sans négociations interminables, et sans agence qui pompe vos revenus." : uiLang === 'it' ? "Unisciti alla rete privata di Acquisition Pro: la nostra IA ti connette direttamente ai brand più redditizi della tua nicchia — senza DM infiniti, senza negoziazioni estenuanti e senza agenzie che ti rubano i profitti." : "Join Acquisition Pro's private network: our AI connects you directly to the most profitable brands in your niche — no endless DMs, no drawn-out negotiations, and no agency stealing your cut."}</p>
                      ...
                      <div className="text-left-mobile" style={{ display: 'flex', flexDirection: 'column', gap: 20, marginBottom: 40 }}>
                          <div style={{ display: 'flex', gap: 16, alignItems: 'flex-start' }}>
                              ...
                              <div style={{ textAlign: 'left' }}>
                                  <div style={{ color: '#fff', fontWeight: 700, fontSize: 16, marginBottom: 4 }}>{uiLang === 'fr' ? 'Matchmaking Automatique' : uiLang === 'it' ? 'Matchmaking Automatico' : 'Automatic Matchmaking'}</div>
                                  <div style={{ color: '#A1A1AA', fontSize: 14 }}>{uiLang === 'fr' ? "Notre IA analyse votre profil et vous connecte instantanément aux marques prêtes à payer le prix fort pour votre audience." : uiLang === 'it' ? "La nostra IA analizza il tuo profilo e ti connette all'istante con brand pronti a pagare cifre top per la tua audience." : "Our AI analyzes your profile and instantly connects you with brands ready to pay top dollar for your audience."}</div>
                              </div>
                          </div>
