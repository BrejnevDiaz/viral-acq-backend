...
export default function ShopAnalyzerTab({ c, mono, API_URL, onImportLead, uiLang, redirectShop, setRedirectShop, userTier, onAnalyzeStore }) {
  ...
  const t = {
    fr: {
      title: "Boutiques Tendances (Shop Analyzer)",
    ...
    en: {
      title: "Shop Analyzer & Trending Stores",
    ...
    it: {
      title: "Analisi Store Vincenti (Shop Analyzer)",
            ...
            <div style={{ display: "flex", gap: 6, flex: "0 0 190px", justifyContent: "flex-end" }}>
              ...
              <button
                onClick={() => onImportLead({
                  ...
                  platformId: "web",
                  niche: s.niche,
                  region: String(s.countries?.[0]?.code || "").toLowerCase(),
                  contact: s.contact,
                  instagram: null,
                  socials: {},
                  score: 95,
                    ...
                    <button 
                      onClick={() => {
                        onImportLead({
                          ...
                          region: String(activeShop.countries?.[0]?.code || "").toLowerCase(),
