...
export default function LandingFeatures({ openAuthWithIntent, uiLang }) {
  return (
    <>
            ...
            <div style={{ display: 'flex', justifyContent: 'center', gap: 60, flexWrap: 'wrap', marginTop: 40, borderTop: `1px solid ${L.border}`, paddingTop: 40 }}>
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: 16, textAlign: 'left', maxWidth: 350 }}>
                   ...
                   <div>
                      ...
                      <div style={{ fontSize: 12, fontWeight: 'bold', color: L.text, textTransform: 'uppercase', letterSpacing: 1 }}>{uiLang === 'fr' ? <>Thomas, <span style={{ color: '#8B5CF6' }}>Marque E-com</span></> : uiLang === 'it' ? <>Thomas, <span style={{ color: '#8B5CF6' }}>Brand E-com</span></> : <>Thomas, <span style={{ color: '#8B5CF6' }}>E-com Brand</span></>}</div>
                   </div>
                </div>
            </div>
          </section>
          ...
          <section id="matchmaking" style={{ maxWidth: 1100, margin: '0 auto', padding: '120px 24px', display: 'flex', flexDirection: 'column', gap: 160, position: 'relative', zIndex: 10 }}>
            ...
            <div className="flex-col-mobile" style={{ display: 'flex', alignItems: 'center', gap: 80, justifyContent: 'space-between' }}>
              <div className="text-center-mobile" style={{ flex: 1, maxWidth: 450 }}>
                ...
                <p style={{ fontSize: 16, color: L.textMuted, lineHeight: 1.6, marginBottom: 32 }}>
                ...
                <button onClick={() => openAuthWithIntent('matchmaking')} style={{
                 ...
                 <div style={{ padding: 24, height: '100%', display: 'flex', flexDirection: 'column' }}>
                    ...
                    <div style={{ flex: 1, display: 'grid', gridTemplateColumns: '1fr 1fr', gridTemplateRows: '1fr 1fr', gap: 16 }}>
                        ...
                        <div style={{ background: '#000', borderRadius: 16, position: 'relative', overflow: 'hidden', border: '1px solid rgba(255,255,255,0.1)' }}>
                            <img src="https://images.unsplash.com/photo-1524250502761-1ac6f2e30d43?auto=format&fit=crop&w=400&q=80" style={{ width: '100%', height: '100%', objectFit: 'cover', opacity: 0.7 }} />
                            <div style={{ position: 'absolute', bottom: 0, left: 0, right: 0, padding: 12, background: 'linear-gradient(0deg, rgba(0,0,0,0.9), transparent)' }}>
                        ...
                        {/* Influencer 3 */}
                        <div style={{ background: '#000', borderRadius: 16, position: 'relative', overflow: 'hidden', border: '1px solid rgba(255,255,255,0.1)' }}>
                            <img src="https://images.unsplash.com/photo-1499996860823-5214fcc65f8f?auto=format&fit=crop&w=400&q=80" style={{ width: '100%', height: '100%', objectFit: 'cover', opacity: 0.7 }} />
                            <div style={{ position: 'absolute', bottom: 0, left: 0, right: 0, padding: 12, background: 'linear-gradient(0deg, rgba(0,0,0,0.9), transparent)' }}>
                                <div style={{ color: '#fff', fontSize: 12, fontWeight: 'bold' }}>@travel_maya</div>
                                <div style={{ color: '#8B5CF6', fontSize: 10, fontWeight: 'bold' }}>91% Match</div>
                            </div>
                        </div>
                        {/* Influencer 4 */}
                        <div style={{ background: '#000', borderRadius: 16, position: 'relative', overflow: 'hidden', border: '1px solid rgba(255,255,255,0.1)' }}>
                            <img src="https://images.unsplash.com/photo-1548142813-c348350df52b?auto=format&fit=crop&w=400&q=80" style={{ width: '100%', height: '100%', objectFit: 'cover', opacity: 0.7 }} />
                            <div style={{ position: 'absolute', bottom: 0, left: 0, right: 0, padding: 12, background: 'linear-gradient(0deg, rgba(0,0,0,0.9), transparent)' }}>
                                <div style={{ color: '#fff', fontSize: 12, fontWeight: 'bold' }}>@fitcoach_leo</div>
                                <div style={{ color: '#8B5CF6', fontSize: 10, fontWeight: 'bold' }}>88% Match</div>
                            </div>
                        </div>
                    </div>
                 </div>
            ...
            <div className="flex-col-mobile" style={{ display: 'flex', alignItems: 'center', gap: 80, justifyContent: 'space-between', flexDirection: 'row-reverse' }}>
              <div className="text-center-mobile" style={{ flex: 1, maxWidth: 450 }}>
                ...
                <button onClick={() => openAuthWithIntent('acquisition')} style={{
                  background: 'linear-gradient(90deg, #8B5CF6, #7C3AED)', color: '#fff', border: 'none',
                  padding: '12px 28px', borderRadius: 8, fontSize: 15, fontWeight: 700, cursor: 'pointer',
                  boxShadow: '0 8px 25px rgba(139,92,246,0.3)', transition: 'transform 0.2s'
                }} className="hover-lift">
            ...
            <div className="flex-col-mobile" style={{ maxWidth: 1100, margin: '0 auto', padding: '0 24px', display: 'flex', alignItems: 'center', gap: 80, justifyContent: 'space-between', marginTop: 120, marginBottom: 80, boxSizing: 'border-box' }}>
              <div className="text-center-mobile" style={{ flex: 1, maxWidth: 500 }}>
                ...
                <button 
                  onClick={() => openAuthWithIntent('shopanalyzer')}
                  style={{
              ...
              {/* 3D Bar Charts Mockup area — wrapped in a dark card like the other
                  product mockups, since its glassy white bars need a dark backdrop */}
              <div style={{ flex: 1, height: 400, borderRadius: 24, background: 'linear-gradient(135deg, #18181B 0%, #09090B 100%)', border: '1px solid rgba(255,255,255,0.1)', boxShadow: '0 30px 60px rgba(0,0,0,0.4)', position: 'relative', display: 'flex', justifyContent: 'center', alignItems: 'flex-end', overflow: 'hidden' }}>
                 {/* Fake 3D Bars */}
