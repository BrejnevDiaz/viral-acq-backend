  ...
  return (
    <div style={{ display: "flex", gap: 24, animation: "fadeIn 0.4s ease-out", flexWrap: "wrap", alignItems: "flex-start" }}>
      ...
      <div style={{ background: c.card, border: `1px solid ${c.border}`, borderRadius: 14, padding: 24, marginBottom: 20 }}>
        <h2 style={{ margin: "0 0 16px 0", fontSize: 18, fontFamily: mono, color: c.text, display: "flex", alignItems: "center", gap: 12, fontWeight: 800 }}>
      ...
      <div style={{ flex: "0 0 320px", background: c.card, border: `1px solid ${c.border}`, borderRadius: 14, padding: 20, minHeight: 400 }}>
        <h3 style={{ margin: "0 0 16px 0", fontSize: 16, fontFamily: mono, color: c.text, display: "flex", alignItems: "center", gap: 10 }}>{<div style={{ width: 28, height: 28, borderRadius: 8, background: `linear-gradient(135deg, #8b5cf6, #6d28d9)`, display: "flex", alignItems: "center", justifyContent: "center", color: "#fff", boxShadow: "0 4px 12px rgba(139,92,246,0.3)" }}>
  <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/><polyline points="10 9 9 9 8 9"/></svg>
</div>} Historique ({history.length})</h3>
        {history.length === 0 ? (
